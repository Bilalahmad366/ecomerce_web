      ...
      <div>
        <nav>
          <ul class="nav flex justify-between py-2 m-0 px-3 ">
            ...
            >
            <li v-if="cross" @:click="Cross" id="cross" ><i class="fa-solid fa-circle-xmark"></i></li>
              <li><RouterLink to="/">home</RouterLink></li>
              <li><RouterLink to="/adminpage" target="_blank" >admin panel</RouterLink></li>
              <li><routerLink class="logout lg:absolute lg:right-16 lg:top-3"  @:click="logout"><i class="fa-solid fa-right-from-bracket text-xl"></i></routerLink></li>
...
.catagory{
  position: relative;
  box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 10px 40px 0px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;
   overflow: hidden;
   background: #E1EBEE;
}
.catagory:hover{
